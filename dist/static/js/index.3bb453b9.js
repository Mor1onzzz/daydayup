(()=>{var e={3541:function(e,t,i){"use strict";var o=i(2676),r=i(5271),n=i(8751),a=i(5426),s=i(614);i(3052);var l=i(4767);let d={request:{token:["ghp_POKLPJsLlupuS0qR","JZ7aYwuMXivIgG4Ne353"],clientID:"694df1779e48d5a450d3",clientSecret:"23420dd29f671adc5107a5565ed47f655f8e1260",pageSize:6,autoProxy:"https://cors-anywhere.azm.workers.dev/https://github.com/login/oauth/access_token",owner:"Mor1onzzz",repo:"daydayup"},app:{onlyShowOwner:!1,enableRepoSwitcher:!0,enableAbout:!1,enableEgg:!1}},c=window.GWITTER_CONFIG;c&&(c.request&&(d.request={...d.request,...c.request}),c.app&&(d.app={...d.app,...c.app}));let p=e=>l.Z.create({baseURL:"https://api.github.com/",headers:{Accept:"application/json",Authorization:`bearer ${e}`}}),u=p(d.request.token.join("")),h=e=>{let t=`
